...
// DB config
const db = 'mongodb+srv://marcelpolocha1:081358pius@cluster0.f9a85hv.mongodb.net/gcashProps';
mongoose.connect(db)
...
app.get('/siteAdminiPages', async (req, res) => {
...
app.post('/suspendUser/:id', async (req, res) => {
  try {
    ...
    if (!user) {
      ...
      return res.redirect('/siteAdminiPages');
    }
